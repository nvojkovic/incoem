...
const WhoDies = ({ active, setWhoDies, i, title, age, setAge }: any) => {
  return (
    <div
      className={`px-3 ${active ? "bg-main-orange text-white" : "bg-gray-200"} h-10 flex items-center gap-2 cursor-pointer border border-gray-300 border-1 ${i == 1 && "rounded-e-lg"} ${i == -1 && "rounded-s-lg text-xs"}`}
