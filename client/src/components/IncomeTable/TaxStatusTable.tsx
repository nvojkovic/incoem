              ...
              <table className="border bg-white !text-sm w-full">
                ...
                >
                  <tr>
                    ...
                    <th
                      className={` font-medium ${selectedColumn?.type === "age" ? "!bg-slate-200" : ""}`}
                    ...
                    {Object.keys(groupedIncomesByTaxType).map((key) => (
                      <th
                        className={`px-2 font-medium ${selectedColumn?.type === key ? "!bg-slate-200" : ""}`}
                  ...
                  {yearRange(
                    ...
                    return (
                      ...
                      >
                        ...
                        {Object.keys(groupedIncomesByTaxType).map((key) => (
                          <td
                            className={`px-2 py-[0.45rem] ${selectedColumn?.type === key ? "!bg-slate-200" : ""}`}
                          >
